...
class AI_Assistant:
    def __init__(self):
        aai.settings.api_key = "API-KEY" # assembly
        self.openai_client = OpenAI(api_key = "API-KEY") # OpenAI
        self.elevenlabs_api_key = "API-KEY" # ElevenLabs
...
greeting = "Hi, I'\m Abdulmalik Bot"
